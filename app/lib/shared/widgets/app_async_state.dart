...
class AppAsyncState extends StatelessWidget {
  ...
  @override Widget build(BuildContext context){
    ...
    if(error!=null)return Center(child:AppCard(child:Column(mainAxisSize:MainAxisSize.min,children:[const AppIcon(Icons.cloud_off_outlined,size:42),const SizedBox(height:10),Text(error!,textAlign:TextAlign.center),const SizedBox(height:12),AppLiquidGlassButton(label:'重试',onPressed:onRetry)])));
