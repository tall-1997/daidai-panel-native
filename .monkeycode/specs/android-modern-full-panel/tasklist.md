...
**Status:** Complete for implementation and CI contracts in v1.0.12. The PRoot helper loader is packaged and injected through `PROOT_LOADER`; strict physical-device 16 KB execution evidence remains part of the release matrix.
